...
export const Sponsor = ({ text, img, company, link }) => {
  return (
    <div
...
export const SmallerSponsor = ({ img, company, link }) => {
  return (
    <div
