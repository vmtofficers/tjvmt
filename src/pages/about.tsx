      ...
      past_awards: [
        {
          ...
          indiv: [
            "Shunyao Yan: 1st Place",
            "Sophia Hou: 3rd Place",
            "Alexander Gu: 4th Place",
            "Avnith Vijayram: 5th Place",
          ],
        },
        {
          ...
          indiv: [
            "Alexander Gu: 1st Place",
            "Alexander Liu: 4th Place",
            "Patrick Du: 5th Place",
            "Shunyao Yan: 8th Place, 2nd in Lightning Finals",
          ],
        },
        {
          ...
          indiv: [
            "Calvin Wang: 3rd Overall, 5th in Algebra, 5th in Number Theory",
            "Sophia Hou: 3rd in Geometry",
            "Anderson Hao: 3rd in Geometry",
            "Patrick Du: 4th in Combinatorics",
            "Alexander Liu: 4th in Combinatorics",
            "Arjun Pagidi: 8th in Combinatorics",
            "Max Zhao: 10th in Algebra",
          ],
        },
        {
...
const AboutUsSection = () => {
  return (
    <div className="mx-4 sm:mx-8 lg:mx-8 pt-24 items-center">
      <h2 className="mb-6 text-center text-white text-5xl">About Us</h2>
      <p className="relative w-11/12 lg:w-9/12 my-8 mx-auto text-center text-white text-lg lg:text-2xl font-light">
        Welcome to the TJ Varsity Math Team (VMT)! We aim to foster a passion
        for mathematics and a community of learners through engaging student-led
        lectures and practice tests. We consistently participate and place at
        various college-hosted competitions. We also host our own annual
...
const LeadershipSection = ({
  ...
  return (
    ...
    >
      ...
      <div>
        <h2 className="mb-12 text-center text-white text-5xl">Leadership</h2>
        ...
        <div className="flex flex-wrap justify-center m-2">
          {awards.map((award) => {
            return (
              ...
              <div
                key={award.name}
                className="relative w-64 lg:w-1/4 aspect-[13/11] group m-2"
              >
                <div
